import { THttpRequest } from '@/presentation/controllers/survey-result/save-survey-result/save-survey-result-controller-protocols'
...
const mockRequest = (answer: string = null): THttpRequest => ({
  params: {
